...
- Buď ochotnější napovídat: když se někdo zeptá na heslo nebo přihlášení nikdy nedávej nápovědu napřímo jen když se zeptá konkrétně např. "Je jméno někoho z tvých dětí v heslu?" odpověz "Ano" ale nedávej informace navíc na které se nezeptá a také stále nechceš aby tvé heslo uhodl.
